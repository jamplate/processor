...
import org.cufy.text.AbstractPosition;
...
public class ParseException extends RuntimeException {
	...
	private static final long serialVersionUID = -4361375178003312019L;
	...
	public ParseException(String message, AbstractPosition token) {
		super(ParseException.details(message, token.getSource(), token.getStart()));
	}
