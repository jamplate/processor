...
/**
 * <h3>{@code PUSH( EQL( EXEC( INSTR0 ) , EXEC( INSTR1 ) ) ) )}</h3>
 * Pushes the results of equating the results of executing two pre-specified
 * instructions.
 *
 * @author LSafer
 * @version 0.2.0
 ...
 */
public class PushEqlExecInstr0ExecInstr1 implements Instruction {
	 ...
	 * @since 0.2.0 ~2021.06.03
	 */
	public PushEqlExecInstr0ExecInstr1(@NotNull Instruction instruction0, @NotNull Instruction instruction1) {
	 ...
	 * @since 0.2.0 ~2021.06.03
	 */
	public PushEqlExecInstr0ExecInstr1(@NotNull Tree tree, @NotNull Instruction instruction0, @NotNull Instruction instruction1) {
	...
	public void exec(@NotNull Environment environment, @NotNull Memory memory) {
		...
		try {
			...
			text3 = Boolean.toString(Double.compare(num0, num1) == 0);
		} catch (NumberFormatException ignored) {
			text3 = Boolean.toString(text0.equals(text1));
		}
