...
/**
 * <h3>{@code PUSH( SUB( EXEC( INSTR0 ) , EXEC( INSTR1 ) ) ) )}</h3>
 * Pushes the results of subtracting the results of executing two pre-specified
 * instructions.
 *
 * @author LSafer
 * @version 0.2.0
 ...
 */
public class PushSubExecInstr0ExecInstr1 implements Instruction {
	@SuppressWarnings("JavaDoc")
	private static final long serialVersionUID = 3019924109629602710L;
	 ...
	 * executing the given {@code instruction0} by the results of executing the given
	 * {@code instruction1}.
	 *
	 ...
	 * @since 0.2.0 ~2021.06.03
	 */
	public PushSubExecInstr0ExecInstr1(@NotNull Instruction instruction0, @NotNull Instruction instruction1) {
	 ...
	 * @since 0.2.0 ~2021.06.03
	 */
	public PushSubExecInstr0ExecInstr1(@NotNull Tree tree, @NotNull Instruction instruction0, @NotNull Instruction instruction1) {
