 ...
 */
public class SoutExecInstr implements Instruction {
	 ...
	 * @since 0.2.0 ~2021.06.02
	 */
	public SoutExecInstr(@NotNull Instruction instruction) {
	 ...
	 * @since 0.2.0 ~2021.06.02
	 */
	public SoutExecInstr(@NotNull Tree tree, @NotNull Instruction instruction) {
