...
/**
 * <h3>{@code FALLOC( ADDR , CONST )}</h3>
 * An instruction that allocate a pre-specified constant to the heap of the last frame at
 ...
 */
public class FallocAddrConst implements Instruction {
	 ...
	 * {@code address} at the heap of the last frame.
	 *
	 ...
	 * @since 0.2.0 ~2021.05.31
	 */
	public FallocAddrConst(@NotNull String address, @NotNull String constant) {
	 ...
	 * @since 0.2.0 ~2021.05.31
	 */
	public FallocAddrConst(@NotNull Tree tree, @NotNull String address, @NotNull String constant) {
	...
	public void exec(@NotNull Environment environment, @NotNull Memory memory) {
		...
		memory.getFrame().set(address, m -> constant);
	}
