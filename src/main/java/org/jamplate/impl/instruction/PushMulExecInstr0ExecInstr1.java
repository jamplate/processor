...
/**
 * <h3>{@code PUSH( MUL( EXEC( INSTR0 ) , EXEC( INSTR1 ) ) ) )}</h3>
 * Pushes the results of multiplying the results of executing two pre-specified
 * instructions.
 *
 * @author LSafer
 * @version 0.2.0
 ...
 */
@Deprecated
public class PushMulExecInstr0ExecInstr1 implements Instruction {
	 ...
	 * @since 0.2.0 ~2021.06.03
	 */
	public PushMulExecInstr0ExecInstr1(@NotNull Instruction instruction0, @NotNull Instruction instruction1) {
	 ...
	 * @since 0.2.0 ~2021.06.03
	 */
	public PushMulExecInstr0ExecInstr1(@NotNull Tree tree, @NotNull Instruction instruction0, @NotNull Instruction instruction1) {
