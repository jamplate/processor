...
/**
 * <h3>{@code REPREE( ADDR )}</h3>
 * An instruction that frees (replace free) the heap at a pre-specified address.
 *
 * @author LSafer
 * @version 0.2.0
 ...
 */
@Deprecated
public class RepreeAddr implements Instruction {
	...
	/**
	 * Construct a new instruction that frees (replace free) the given {@code address} in
	 ...
	 * @since 0.2.0 ~2021.05.31
	 */
	public RepreeAddr(@NotNull String address) {
	 ...
	 * @since 0.2.0 ~2021.05.31
	 */
	public RepreeAddr(@NotNull Tree tree, @NotNull String address) {
