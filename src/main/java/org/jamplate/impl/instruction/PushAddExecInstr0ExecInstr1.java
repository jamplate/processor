...
/**
 * <h3>{@code PUSH( ADD( EXEC( INSTR0 ) , EXEC( INSTR1 ) ) ) )}</h3>
 * Pushes the results of adding the results of executing two pre-specified instructions.
 *
 * @author LSafer
 * @version 0.2.0
 ...
 */
@Deprecated
public class PushAddExecInstr0ExecInstr1 implements Instruction {
	@SuppressWarnings("JavaDoc")
	private static final long serialVersionUID = -4444435028244547717L;
	 ...
	 * @since 0.2.0 ~2021.06.03
	 */
	public PushAddExecInstr0ExecInstr1(@NotNull Instruction instruction0, @NotNull Instruction instruction1) {
	 ...
	 * @since 0.2.0 ~2021.06.03
	 */
	public PushAddExecInstr0ExecInstr1(@NotNull Tree tree, @NotNull Instruction instruction0, @NotNull Instruction instruction1) {
