 ...
 */
package org.jamplate.instruction.system;
 ...
 * evaluating it to {@link System#err}.
 * <br><br>
 ...
 */
public class Serr implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final Serr INSTANCE = new Serr();
	 ...
	 * results of evaluating it to {@link System#err}.
	 *
	 * @since 0.3.0 ~2021.06.24
	 */
	public Serr() {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? Serr.INSTANCE : new Serr(new Tree(this.tree));
	}
}
