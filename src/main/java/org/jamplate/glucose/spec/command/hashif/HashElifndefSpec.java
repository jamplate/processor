...
/**
 * The specification of the command {@code #elifndef}.
 *
 * @author LSafer
 * @version 0.3.0
 * @since 0.3.0 ~2021.07.08
 */
public class HashElifndefSpec implements Spec {
	/**
	 ...
	 */
	@NotNull
	public static final HashElifndefSpec INSTANCE = new HashElifndefSpec();
	 ...
	 */
	@NotNull
	public static final String KIND = "command:elifndef";
	 ...
	 */
	@NotNull
	public static final String NAME = HashElifndefSpec.class.getSimpleName();

	@NotNull
	@Override
	public Compiler getCompiler() {
		return compiler(
				//target elifndef commands that has not been compiled by a context
				c -> filter(c, is(HashElifndefSpec.KIND)),
				//throw
		...
		return parser(
				p -> group(
						...
						(d, r) -> new Tree(
								d,
								r,
								new Sketch(HashElifndefSpec.KIND),
								CommandSpec.WEIGHT
						),
