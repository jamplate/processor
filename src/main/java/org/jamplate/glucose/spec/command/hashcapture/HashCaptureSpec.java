...
/**
 * The specification of the command {@code #capture}.
 *
 * @author LSafer
 * @version 0.3.0
 * @since 0.3.0 ~2021.07.03
 */
public class HashCaptureSpec implements Spec {
	/**
	 ...
	 */
	@NotNull
	public static final HashCaptureSpec INSTANCE = new HashCaptureSpec();

	/**
	 * The kind of the {@code #capture} command.
	 *
	 * @since 0.3.0 ~2021.07.03
	 */
	@NotNull
	public static final String KIND = "command:capture";
	 ...
	 */
	@NotNull
	public static final String NAME = HashCaptureSpec.class.getSimpleName();

	@NotNull
	@Override
	public Compiler getCompiler() {
		return compiler(
				//target capture commands that has not been compiled by a context
				c -> filter(c, is(HashCaptureSpec.KIND)),
				//throw
		...
		return parser(
				p -> group(
						...
						(d, r) -> new Tree(
								d,
								r,
								new Sketch(HashCaptureSpec.KIND),
								CommandSpec.WEIGHT
						),
