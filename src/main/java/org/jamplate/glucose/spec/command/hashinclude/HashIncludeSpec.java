...
import org.jamplate.glucose.instruction.environment.IExec;
...
/**
 * The specification of the command {@code #include}.
 *
 * @author LSafer
 * @version 0.3.0
 * @since 0.3.0 ~2021.07.10
 */
public class HashIncludeSpec implements Spec {
	/**
	 ...
	 */
	@NotNull
	public static final HashIncludeSpec INSTANCE = new HashIncludeSpec();

	/**
	 * The kind of the {@code #include} command.
	 *
	 * @since 0.3.0 ~2021.07.10
	 */
	@NotNull
	public static final String KIND = "command:include";
	 ...
	 */
	@NotNull
	public static final String NAME = HashIncludeSpec.class.getSimpleName();
	...
	public Compiler getCompiler() {
		return compiler(
				...
				c -> filter(c, is(HashIncludeSpec.KIND)),
				//compile
				c -> (compiler, compilation, tree) -> {
					...
					if (valueT == null)
						throw new CompileException(
								"Command INCLUDE is missing some components",
								tree
						);
		...
		return parser(
				p -> group(
						...
						(d, r) -> new Tree(
								d,
								r,
								new Sketch(HashIncludeSpec.KIND),
								CommandSpec.WEIGHT
						),
