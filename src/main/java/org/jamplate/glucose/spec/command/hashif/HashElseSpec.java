...
/**
 * The specification of the command {@code #else}.
 *
 * @author LSafer
 * @version 0.3.0
 * @since 0.3.0 ~2021.07.08
 */
public class HashElseSpec implements Spec {
	/**
	 ...
	 */
	@NotNull
	public static final HashElseSpec INSTANCE = new HashElseSpec();

	/**
	 * The kind of the {@code #else} command.
	 *
	 * @since 0.3.0 ~2021.07.08
	 */
	@NotNull
	public static final String KIND = "command:else";
	 ...
	 */
	@NotNull
	public static final String NAME = HashElseSpec.class.getSimpleName();

	@NotNull
	@Override
	public Compiler getCompiler() {
		return compiler(
				//target else commands that has not been compiled by a context
				c -> filter(c, is(HashElseSpec.KIND)),
				//throw
