...
/**
 * The specification of the command {@code #elifdef}.
 *
 * @author LSafer
 * @version 0.3.0
 * @since 0.3.0 ~2021.07.08
 */
public class HashElifdefSpec implements Spec {
	/**
	 ...
	 */
	@NotNull
	public static final HashElifdefSpec INSTANCE = new HashElifdefSpec();
	 ...
	 */
	@NotNull
	public static final String KIND = "command:elifdef";
	 ...
	 */
	@NotNull
	public static final String NAME = HashElifdefSpec.class.getSimpleName();

	@NotNull
	@Override
	public Compiler getCompiler() {
		return compiler(
				//target elifdef commands that has not been compiled by a context
				c -> filter(c, is(HashElifdefSpec.KIND)),
				//throw
		...
		return parser(
				p -> group(
						...
						(d, r) -> new Tree(
								d,
								r,
								new Sketch(HashElifdefSpec.KIND),
								CommandSpec.WEIGHT
						),
