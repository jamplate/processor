...
/**
 * The specification of the command {@code #elif}.
 *
 * @author LSafer
 * @version 0.3.0
 * @since 0.3.0 ~2021.07.08
 */
public class HashElifSpec implements Spec {
	/**
	 ...
	 */
	@NotNull
	public static final HashElifSpec INSTANCE = new HashElifSpec();

	/**
	 * The kind of the {@code #elif} command.
	 *
	 * @since 0.3.0 ~2021.07.08
	 */
	@NotNull
	public static final String KIND = "command:elif";
	 ...
	 */
	@NotNull
	public static final String NAME = HashElifSpec.class.getSimpleName();
	...
	public Compiler getCompiler() {
		return compiler(
				...
				c -> filter(c, is(HashElifSpec.KIND)),
				//throw
