...
/**
 * The specification of the command {@code #ifndef}.
 *
 * @author LSafer
 * @version 0.3.0
 * @since 0.3.0 ~2021.07.08
 */
public class HashIfndefSpec implements Spec {
	/**
	 ...
	 */
	@NotNull
	public static final HashIfndefSpec INSTANCE = new HashIfndefSpec();
	 ...
	 */
	@NotNull
	public static final String KIND = "command:ifndef";
	 ...
	 */
	@NotNull
	public static final String NAME = HashIfndefSpec.class.getSimpleName();

	@NotNull
	@Override
	public Compiler getCompiler() {
		return compiler(
				//target ifndef commands that has not been compiled by a context
				c -> filter(c, is(HashIfndefSpec.KIND)),
				//throw
				c -> (compiler, compilation, tree) -> {
					throw new CompileException(
							"#Ifndef without #Endif closing it"
					);
				}
		);
	}
		...
		return parser(
				p -> group(
						...
						(d, r) -> new Tree(
								d,
								r,
								new Sketch(HashIfndefSpec.KIND),
								CommandSpec.WEIGHT
						),
