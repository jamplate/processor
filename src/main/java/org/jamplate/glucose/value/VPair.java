...
public final class VPair implements Value<Entry<Value, Value>> {
	 ...
	 */
	public VPair(@NotNull Pipe<Object, Entry<Value, Value>> pipe) {
	...
	@NotNull
	@Override
	public VPair apply(@NotNull Pipe<Entry<Value, Value>, Entry<Value, Value>> pipe) {
		Objects.requireNonNull(pipe, "pipe");
		return new VPair(this.pipe.apply(pipe));
	}
