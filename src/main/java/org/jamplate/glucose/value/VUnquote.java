 ...
 */
public final class VUnquote implements Value<Value> {
	 ...
	 * @since 0.3.0 ~2021.07.01
	 */
	public VUnquote(@NotNull Pipe<Object, Value> pipe) {
	...
	@NotNull
	@Override
	public VUnquote apply(@NotNull Pipe<Value, Value> pipe) {
		Objects.requireNonNull(pipe, "pipe");
		return new VUnquote(this.pipe.apply(pipe));
	}
