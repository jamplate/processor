 ...
 */
public final class VArray implements Value<List<Value>> {
	 ...
	 */
	public VArray(@NotNull Pipe<Object, List<Value>> pipe) {
	...
	@NotNull
	@Override
	public VArray apply(@NotNull Pipe<List<Value>, List<Value>> pipe) {
		Objects.requireNonNull(pipe, "pipe");
		return new VArray(this.pipe.apply(pipe));
	}
