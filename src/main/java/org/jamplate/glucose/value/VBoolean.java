 ...
 */
public final class VBoolean implements Value<Boolean> {
	 ...
	 * @since 0.3.0 ~2021.07.01
	 */
	public VBoolean(@NotNull Pipe<Object, Boolean> pipe) {
	...
	@NotNull
	@Override
	public VBoolean apply(@NotNull Pipe<Boolean, Boolean> pipe) {
		Objects.requireNonNull(pipe, "pipe");
		return new VBoolean(this.pipe.apply(pipe));
	}
