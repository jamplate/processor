 ...
 */
public final class VText implements Value<String> {
	 ...
	 */
	public VText(@NotNull Pipe<Object, String> pipe) {
	...
	@NotNull
	@Override
	public VText apply(@NotNull Pipe<String, String> pipe) {
		Objects.requireNonNull(pipe, "pipe");
		return new VText(this.pipe.apply(pipe));
	}
