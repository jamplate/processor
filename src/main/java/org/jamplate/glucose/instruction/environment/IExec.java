 ...
 */
package org.jamplate.glucose.instruction.environment;
 ...
 */
public class IExec implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IExec INSTANCE = new IExec();
	 ...
	 * @since 0.3.0 ~2021.06.24
	 */
	public IExec(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IExec.INSTANCE : new IExec(new Tree(this.tree));
	}
}
