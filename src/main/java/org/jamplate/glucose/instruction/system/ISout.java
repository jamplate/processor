 ...
 */
public class ISout implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final ISout INSTANCE = new ISout();
	 ...
	 * @since 0.3.0 ~2021.06.24
	 */
	public ISout(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? ISout.INSTANCE : new ISout(new Tree(this.tree));
	}
}
