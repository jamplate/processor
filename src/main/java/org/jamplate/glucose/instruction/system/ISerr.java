 ...
 */
public class ISerr implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final ISerr INSTANCE = new ISerr();
	 ...
	 * @since 0.3.0 ~2021.06.24
	 */
	public ISerr(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? ISerr.INSTANCE : new ISerr(new Tree(this.tree));
	}
}
