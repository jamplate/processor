 ...
 */
public class ICastArray implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final ICastArray INSTANCE = new ICastArray();
	 ...
	 * @since 0.3.0 ~2021.06.13
	 */
	public ICastArray(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? ICastArray.INSTANCE : new ICastArray(new Tree(this.tree));
	}
}
