 ...
 */
public class ICompare implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final ICompare INSTANCE = new ICompare();
	 ...
	 * @since 0.3.0 ~2021.06.13
	 */
	public ICompare(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? ICompare.INSTANCE : new ICompare(new Tree(this.tree));
	}
}
