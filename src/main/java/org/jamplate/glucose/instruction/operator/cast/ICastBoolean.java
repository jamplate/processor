 ...
 */
public class ICastBoolean implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final ICastBoolean INSTANCE = new ICastBoolean();
	 ...
	 * @since 0.3.0 ~2021.06.13
	 */
	public ICastBoolean(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? ICastBoolean.INSTANCE : new ICastBoolean(new Tree(this.tree));
	}
}
