 ...
 */
public class BuildObject implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final BuildObject INSTANCE = new BuildObject();
	 ...
	 * @since 0.3.0 ~2021.07.06
	 */
	public BuildObject(@NotNull Tree tree) {
	...
	public void exec(@NotNull Environment environment, @NotNull Memory memory) {
		...
		if (value0 instanceof GlueValue) {
			...
			ObjectValue value2 = object(pairs1);
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? BuildObject.INSTANCE : new BuildObject(new Tree(this.tree));
	}
}
