 ...
 */
public class ICastPair implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final ICastPair INSTANCE = new ICastPair();
	 ...
	 * @since 0.3.0 ~2021.07.01
	 */
	public ICastPair(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? ICastPair.INSTANCE : new ICastPair(new Tree(this.tree));
	}
}
