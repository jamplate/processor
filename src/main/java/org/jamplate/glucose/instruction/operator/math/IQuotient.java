 ...
 */
public class IQuotient implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IQuotient INSTANCE = new IQuotient();
	 ...
	 * @since 0.3.0 ~2021.06.12
	 */
	public IQuotient(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IQuotient.INSTANCE : new IQuotient(new Tree(this.tree));
	}
}
