 ...
 */
public class IDefined implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IDefined INSTANCE = new IDefined();
	 ...
	 * @since 0.3.0 ~2021.06.25
	 */
	public IDefined(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IDefined.INSTANCE : new IDefined(new Tree(this.tree));
	}
}
