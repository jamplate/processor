 ...
 */
public class IProduct implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IProduct INSTANCE = new IProduct();
	 ...
	 * @since 0.3.0 ~2021.06.12
	 */
	public IProduct(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IProduct.INSTANCE : new IProduct(new Tree(this.tree));
	}
}
