 ...
 * <br>
 * If the popped values is not both {@link VGlue}s, an {@link ExecutionException} will
 * be thrown.
 * <br><br>
 ...
 */
public class IBuildPair implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IBuildPair INSTANCE = new IBuildPair();
	 ...
	 * @since 0.3.0 ~2021.07.06
	 */
	public IBuildPair(@NotNull Tree tree) {
	...
	public void exec(@NotNull Environment environment, @NotNull Memory memory) {
		...
		if (value0 instanceof VGlue && value1 instanceof VGlue) {
			//value
			VGlue glue0 = (VGlue) value0;
			List<Value> list0 = glue0.getPipe().eval(memory);
			//key
			VGlue glue1 = (VGlue) value1;
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IBuildPair.INSTANCE : new IBuildPair(new Tree(this.tree));
	}
}
