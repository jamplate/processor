 ...
 */
public class IRepeat implements Instruction {
	 ...
	 * @since 0.3.0 ~2021.06.15
	 */
	public IRepeat(@NotNull Instruction instruction) {
	 ...
	 * @since 0.3.0 ~2021.06.15
	 */
	public IRepeat(@NotNull Tree tree, @NotNull Instruction instruction) {
