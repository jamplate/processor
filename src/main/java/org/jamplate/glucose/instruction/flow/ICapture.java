 ...
 */
public class ICapture implements Instruction {
	 ...
	 * @since 0.3.0 ~2021.07.03
	 */
	public ICapture(@NotNull Instruction instruction) {
	 ...
	 * @since 0.3.0 ~2021.07.03
	 */
	public ICapture(@NotNull Tree tree, @NotNull Instruction instruction) {
