 ...
 */
public class IPushFrame implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IPushFrame INSTANCE = new IPushFrame();
	 ...
	 * @since 0.3.0 ~2021.06.12
	 */
	public IPushFrame(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IPushFrame.INSTANCE : new IPushFrame(new Tree(this.tree));
	}
}
