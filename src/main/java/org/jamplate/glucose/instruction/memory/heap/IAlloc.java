 ...
 */
public class IAlloc implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IAlloc INSTANCE = new IAlloc();
	 ...
	 * @since 0.3.0 ~2021.06.15
	 */
	public IAlloc(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IAlloc.INSTANCE : new IAlloc(new Tree(this.tree));
	}
}
