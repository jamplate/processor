 ...
 */
public class ISwap implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final ISwap INSTANCE = new ISwap();
	 ...
	 * @since 0.3.0 ~2021.06.15
	 */
	public ISwap(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? ISwap.INSTANCE : new ISwap(new Tree(this.tree));
	}
}
