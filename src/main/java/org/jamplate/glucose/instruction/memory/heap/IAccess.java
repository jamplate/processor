 ...
 */
package org.jamplate.glucose.instruction.memory.heap;
 ...
 */
public class IAccess implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IAccess INSTANCE = new IAccess();
	 ...
	 * @since 0.3.0 ~2021.06.15
	 */
	public IAccess(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IAccess.INSTANCE : new IAccess(new Tree(this.tree));
	}
}
