 ...
 * array concatenation.
 * <br>
 * If one of the values is not an {@link VArray array}, an {@link ExecutionException}
 * will be thrown.
 * <br><br>
 ...
 */
public class IConcatFrame implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final IConcatFrame INSTANCE = new IConcatFrame();
	 ...
	 * @since 0.3.0 ~2021.06.15
	 */
	public IConcatFrame(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? IConcatFrame.INSTANCE : new IConcatFrame(new Tree(this.tree));
	}
}
