 ...
 */
public class ISetConsole implements Instruction {
	/**
	 ...
	 */
	@NotNull
	public static final ISetConsole INSTANCE = new ISetConsole();
	 ...
	 * @since 0.3.0 ~2021.06.15
	 */
	public ISetConsole(@NotNull Tree tree) {
	...
	public Instruction optimize(int mode) {
		return mode < 0 ? ISetConsole.INSTANCE : new ISetConsole(new Tree(this.tree));
	}
}
