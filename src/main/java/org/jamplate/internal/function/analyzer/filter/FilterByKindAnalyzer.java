...
/**
 * An analyzer that analyzes using another analyzer and only analyzes trees with one of
 * pre-specified kinds.
 *
 * @author LSafer
 * @version 0.3.0
 ...
 */
public class FilterByKindAnalyzer implements Analyzer {
	/**
	...
	/**
	 * Construct a new analyzer that analyzes the trees with the given {@code kind} using
	 * the given {@code analyzer}.
	 *
	 * @param kind     the kind of trees to analyze.
	 * @param analyzer the analyzer to be used.
	 * @throws NullPointerException if the given {@code kind} or {@code analyzer} is
	 *                              null.
	 * @since 0.3.0 ~2021.06.15
	 */
	public FilterByKindAnalyzer(@NotNull String kind, @NotNull Analyzer analyzer) {
	 ...
	 *
	 * @param analyzer the analyzer to be used.
	 * @param kinds    the kinds of trees to analyze.
	 * @throws NullPointerException if the given {@code analyzer} or {@code kinds} is
	 *                              null.
	 * @since 0.3.0 ~2021.06.15
	 */
	public FilterByKindAnalyzer(@NotNull Analyzer analyzer, @Nullable String @NotNull ... kinds) {
