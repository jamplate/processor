...
/**
 * Parentheses {@code ()} specification.
 *
 * @author LSafer
 * @version 0.3.0
 * @since 0.3.0 ~2021.06.20
 */
public class ParenthesesSpec implements Spec {
	/**
	 ...
	 */
	@NotNull
	public static final ParenthesesSpec INSTANCE = new ParenthesesSpec();

	/**
	 * The kind of a parentheses {@code ()} context.
	 *
	 * @since 0.3.0 ~2021.06.20
	 */
	@NotNull
	public static final String KIND = "enclosure:parentheses";
	 ...
	 */
	@NotNull
	public static final String NAME = ParenthesesSpec.class.getSimpleName();
	...
	public Parser getParser() {
		return Functions.parser(
				...
				p -> new EnclosureParser(
						Pattern.compile("\\("),
						Pattern.compile("\\)"),
						(d, r) -> new Tree(d, r, new Sketch(ParenthesesSpec.KIND)),
